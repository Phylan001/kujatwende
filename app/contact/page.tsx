          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl text-white/80 mb-8">
                Ready to start your adventure? We're here to help you plan the perfect Kenyan experience.
              </p>
            </div>
          </div>
        </section>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="glass rounded-xl p-6">
                    <h3 className="text-white font-semibold mb-2">How far in advance should I book?</h3>
                    <p className="text-white/70 text-sm">
                      We recommend booking at least 2-4 weeks in advance, especially during peak seasons (July-October).
                    </p>
                  </div>

                  <div className="glass rounded-xl p-6">
                    <h3 className="text-white font-semibold mb-2">What's included in the packages?</h3>
                    <p className="text-white/70 text-sm">
                      Most packages include accommodation, meals, transportation, and guided activities. Specific
                      inclusions vary by package.
                    </p>
                  </div>

                  <div className="glass rounded-xl p-6">
                    <h3 className="text-white font-semibold mb-2">Do you offer custom packages?</h3>
                    <p className="text-white/70 text-sm">
                      Yes! We specialize in creating personalized adventures tailored to your preferences and budget.
                    </p>
                  </div>
                </div>
              </div>
