...
const destinations: Destination[] = [
  {
    ...
    name: "Maasai Mara",
    description:
      "World-famous wildlife reserve known for the Great Migration and Big Five game viewing.",
  ...
  },
  {
    ...
    description:
      "Spectacular views of Mount Kilimanjaro and large elephant herds.",
  ...
  },
  {
    ...
    name: "Diani Beach",
    description:
      "Pristine white sand beaches and crystal clear waters on the Kenyan coast.",
  ...
  },
  {
    ...
    name: "Mount Kenya",
    description:
      "Africa's second highest peak offering challenging climbs and stunning scenery.",
  ...
  },
  {
    ...
    description:
      "Unique wildlife and cultural experiences in Kenya's northern frontier.",
  ...
  },
  {
    ...
    name: "Lake Nakuru",
    description:
      "Famous for flamingos and rhino sanctuary in the Great Rift Valley.",
    ...
    if (selectedCategory === "all") {
      ...
      const filtered = destinations.filter((dest) => {
        if (selectedCategory === "wildlife")
          return ["maasai-mara", "amboseli", "samburu", "lake-nakuru"].includes(
            dest.id
          );
        ...
        if (selectedCategory === "cultural")
          return ["maasai-mara", "samburu"].includes(dest.id);
        return true;
      });
